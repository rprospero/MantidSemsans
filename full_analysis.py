...
MASK = r"\\isis\inst$\NDXLARMOR\User"\
       r"\Users\Masks\USER_Edler_171B_a2_8mm_SEMSANS_r20287.txt"
TUBES = [39, 40, 41]
...
def analyse(data_table, blank_table, output_file,
    ...
    blank_table
      The Workspace table object containing the runs which hold the blank
      measurements.  Again, this should be generated by get_log
    output_file
